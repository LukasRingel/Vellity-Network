...
class SelectRequestsForPlayer(private val context: Context, private val player: UUID) : SelectQuery<FriendRequest> {
  override fun query(): String {
    return "select * from friends_users_requests where target = ? and context = ? and activeUntil > now();"
  }
