...
class SelectHistoryFromHistoryTable(private val playerId: UUID, private val context: Context) :
  SelectQuery<GroupHistoryEntry> {
  override fun query(): String =
    "select * from access_users_groups_history where player = ? and (context = ? or context = " + Context.ALL.ordinal + ")"
