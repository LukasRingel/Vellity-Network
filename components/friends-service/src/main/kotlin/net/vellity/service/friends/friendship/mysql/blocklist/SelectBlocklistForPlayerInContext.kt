...
class SelectBlocklistForPlayerInContext(private val context: Context, private val player: UUID): SelectQuery<BlocklistEntry> {
  override fun query(): String {
    return "select * from friends_users_blocked where context = ? and player = ? and activeUntil > now();"
  }
